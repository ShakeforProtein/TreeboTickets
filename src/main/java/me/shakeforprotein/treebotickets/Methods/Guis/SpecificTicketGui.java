...
public class SpecificTicketGui {
    ...
    public SpecificTicketGui(TreeboTickets main) {
        this.pl = main;
    }
    ...
    public void specificTicketGui(Player p, int t, String menuName, String fromMenu) {
                ...
                try {
                    ...
                    while (response.next()) {
                        ...
                        if (fromMenu.equalsIgnoreCase("Open")) {
                            backMetaLore.add("Open");
                        }
                        if (fromMenu.equalsIgnoreCase("Closed")) {
                            backMetaLore.add("Closed");
                        }
                        if (fromMenu.equalsIgnoreCase("Assigned")) {
                            backMetaLore.add("Assigned");
                        }
                        if (fromMenu.equalsIgnoreCase("Unassigned")) {
                            backMetaLore.add("Unassigned");
                        }
                        if (fromMenu.equalsIgnoreCase("Builder")) {
                            backMetaLore.add("Builder");
                        }
                        ...
                        if (p.hasPermission("tbtickets.admin")) {
                            closeMetaLore.add("tbticketadmin close " + tId);
                            ...
                            closeMetaLore.add("review close " + tId);
                        ...
                        if (p.hasPermission("tbtickets.admin")) {
                            teleportMetaLore.add("tbticketadmin tp " + tId);
                        } else if (p.hasPermission("tbtickets.mod.view")) {
                            teleportMetaLore.add("tbta tp " + tId);
                        } else if (p.hasPermission("tbtickets.builder")) {
                            teleportMetaLore.add("review tp " + tId);
                        }

                        if (p.hasPermission("tbtickets.admin")) {
                            deleteMetaLore.add("tbticketadmin delete " + tId);
                        } else if (p.hasPermission("tbtickets.mod.view")) {
                            deleteMetaLore.add("tbta close " + tId);
                        } else if (p.hasPermission("tbtickets.builder")) {
                            teleportMetaLore.add("review close " + tId);
                        }
